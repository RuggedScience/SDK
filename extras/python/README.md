# Python SDK
This is a wrapper around the [Rugged Science SDK](/README.md) with the only difference being that exceptions are automatically thrown. For more information about the available APIs see the [librsdio](/librsdio.md) and [librspoe](/librspoe.md) docs. 
