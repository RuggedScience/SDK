...
{
    std::cout
        << "Usage: rspoectl FILE COMMAND [PORT] [OPTIONS...]\n"
        << "Commands:\n"
...
int main(int argc, char* argv[])
{
    ...
    if (port == -1 &&
        (cmd == "s=" || cmd == "state=" || cmd == "s" || cmd == "state" ||
         cmd == "v" || cmd == "voltage" || cmd == "c" || cmd == "current" ||
         cmd == "w" || cmd == "wattage")) {
